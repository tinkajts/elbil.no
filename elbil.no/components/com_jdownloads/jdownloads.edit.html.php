...
<?php
echo JHtml::_('bootstrap.startTabSet', 'jd_edit_file', array('active' => 'daten1'));
echo JHtml::_('bootstrap.addTab', 'jd_edit_file', 'daten1', JText::_('COM_JDOWNLOADS_BACKEND_FILESEDIT_TABTITLE_1', true));
?>
...
echo JHtml::_('bootstrap.addTab', 'jd_edit_file', 'daten2', JText::_('COM_JDOWNLOADS_BACKEND_FILESEDIT_TABTITLE_2', true));
?>
<table width="100%" border="0">
    <tr>
        <td width="100%" valign="top">
...
<?php
echo JHtml::_('bootstrap.endTab');
echo JHtml::_('bootstrap.addTab', 'jd_edit_file', 'daten3', JText::_('COM_JDOWNLOADS_BACKEND_FILESEDIT_TABTITLE_3', true));
?>
<table width="100%" border="0">
    <tr>
        <td width="100%" valign="top">
