...
<?php if($this->params->get('ship_company_name', 2) != 3 ): ?>
  ...
  <tr>
    <td><span class="required">*</span> <?php echo JText::_('J2STORE_POSTCODE'); ?></td>
    <td><input type="text" name="zip" value="<?php echo  $this->data['zip']; ?>" class="large-field" /></td>
  </tr>
  <tr>
  <td><span class="required">*</span> <?php echo JText::_('J2STORE_COUNTRY'); ?></td>
  ...
  <tr>
    <td><?php echo JText::_('J2STORE_MOBILE'); ?></td>
