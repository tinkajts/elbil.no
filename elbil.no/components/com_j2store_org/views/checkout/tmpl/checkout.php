		...
		success: function(json) {
			...
			if (json['redirect']) {
				...
				if (json['error']['first_name']) {
					$('#billing-address input[name=\'first_name\'] + br').after('<span class="j2error">' + json['error']['first_name'] + '</span>');
				}

				if (json['error']['last_name']) {
					$('#billing-address input[name=\'last_name\'] + br').after('<span class="j2error">' + json['error']['last_name'] + '</span>');
				}

				if (json['error']['email']) {
					$('#billing-address input[name=\'email\'] + br').after('<span class="j2error">' + json['error']['email'] + '</span>');
				}

				if (json['error']['phone_1']) {
					$('#billing-address input[name=\'phone_1\'] + br').after('<span class="j2error">' + json['error']['phone_1'] + '</span>');
				}

				if (json['error']['company']) {
					$('#billing-address input[name=\'company\'] + br').after('<span class="j2error">' + json['error']['company'] + '</span>');
				}

				if (json['error']['tax_number']) {
					$('#billing-address input[name=\'tax_number\'] + br').after('<span class="j2error">' + json['error']['tax_number'] + '</span>');
				}

				if (json['error']['address_1']) {
					$('#billing-address input[name=\'address_1\'] + br').after('<span class="j2error">' + json['error']['address_1'] + '</span>');
				}

				if (json['error']['city']) {
					$('#billing-address input[name=\'city\'] + br').after('<span class="j2error">' + json['error']['city'] + '</span>');
				}

				if (json['error']['zip']) {
					$('#billing-address input[name=\'zip\'] + br').after('<span class="j2error">' + json['error']['zip'] + '</span>');
				}

				if (json['error']['country']) {
					$('#billing-address select[name=\'country_id\'] + br').after('<span class="j2error">' + json['error']['country'] + '</span>');
				}

				if (json['error']['zone']) {
					$('#billing-address select[name=\'zone_id\'] + br').after('<span class="j2error">' + json['error']['zone'] + '</span>');
				}
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['redirect']) {
				...
				if (json['error']['first_name']) {
					$('#billing-address input[name=\'first_name\']').after('<span class="j2error">' + json['error']['first_name'] + '</span>');
				}

				if (json['error']['last_name']) {
					$('#billing-address input[name=\'last_name\']').after('<span class="j2error">' + json['error']['last_name'] + '</span>');
				}

				if (json['error']['phone_1']) {
					$('#billing-address input[name=\'phone_1\']').after('<span class="j2error">' + json['error']['phone_1'] + '</span>');
				}

				if (json['error']['company']) {
					$('#billing-address input[name=\'company\']').after('<span class="j2error">' + json['error']['company'] + '</span>');
				}

				if (json['error']['tax_number']) {
					$('#billing-address input[name=\'tax_number\']').after('<span class="j2error">' + json['error']['tax_number'] + '</span>');
				}

				if (json['error']['address_1']) {
					$('#billing-address input[name=\'address_1\']').after('<span class="j2error">' + json['error']['address_1'] + '</span>');
				}

				if (json['error']['city']) {
					$('#billing-address input[name=\'city\']').after('<span class="j2error">' + json['error']['city'] + '</span>');
				}

				if (json['error']['zip']) {
					$('#billing-address input[name=\'zip\']').after('<span class="j2error">' + json['error']['zip'] + '</span>');
				}

				if (json['error']['country']) {
					$('#billing-address select[name=\'country_id\']').after('<span class="j2error">' + json['error']['country'] + '</span>');
				}

				if (json['error']['zone']) {
					$('#billing-address select[name=\'zone_id\']').after('<span class="j2error">' + json['error']['zone'] + '</span>');
				}
			} else {
				<?php if ($this->showShipping) { ?>
				$.ajax({
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['redirect']) {
				...
				if (json['error']['first_name']) {
					$('#shipping-address input[name=\'first_name\']').after('<span class="j2error">' + json['error']['first_name'] + '</span>');
				}

				if (json['error']['last_name']) {
					$('#shipping-address input[name=\'last_name\']').after('<span class="j2error">' + json['error']['last_name'] + '</span>');
				}

				if (json['error']['phone_1']) {
					$('#shipping-address input[name=\'phone_1\']').after('<span class="j2error">' + json['error']['phone_1'] + '</span>');
				}

				if (json['error']['company']) {
					$('#shipping-address input[name=\'company\']').after('<span class="j2error">' + json['error']['company'] + '</span>');
				}

				if (json['error']['address_1']) {
					$('#shipping-address input[name=\'address_1\']').after('<span class="j2error">' + json['error']['address_1'] + '</span>');
				}

				if (json['error']['city']) {
					$('#shipping-address input[name=\'city\']').after('<span class="j2error">' + json['error']['city'] + '</span>');
				}

				if (json['error']['zip']) {
					$('#shipping-address input[name=\'zip\']').after('<span class="j2error">' + json['error']['zip'] + '</span>');
				}

				if (json['error']['country']) {
					$('#shipping-address select[name=\'country_id\']').after('<span class="j2error">' + json['error']['country'] + '</span>');
				}

				if (json['error']['zone']) {
					$('#shipping-address select[name=\'zone_id\']').after('<span class="j2error">' + json['error']['zone'] + '</span>');
				}
			} else {
				$.ajax({
					url: 'index.php',
		...
		success: function(json) {
			...
			if (json['redirect']) {
				...
				if (json['error']['phone_2']) {
					$('#shipping-address input[name=\'phone_2\']').after('<span class="j2error">' + json['error']['phone_2'] + '</span>');
				}
			} else {
				$.ajax({
					url: 'index.php',
