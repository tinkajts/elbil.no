...
<div class="left span5">
  <h2><?php echo JText::_('J2STORE_CHECKOUT_YOUR_DETAILS'); ?></h2>
  <span class="required">*</span> <?php echo JText::_('J2STORE_FIRST_NAME'); ?><br />
  <input type="text" name="first_name" value="" class="large-field" />
  <br />
  <br />
  <span class="required">*</span> <?php echo JText::_('J2STORE_LAST_NAME'); ?><br />
  <input type="text" name="last_name" value="" class="large-field" />
  <br />
  <br />
  <span class="required">*</span> <?php echo JText::_('J2STORE_EMAIL'); ?><br />
  <input type="text" name="email" value="" class="large-field" />
  <br />
  <br />
  <span class="required">*</span> <?php echo JText::_('J2STORE_TELEPHONE'); ?><br />
  <input type="text" name="phone_1" value="" class="large-field" />
  <br />
  <br />
  <?php echo JText::_('J2STORE_MOBILE'); ?><br />
  <input type="text" name="phone_2" value="" class="large-field" />
  <br />
  <br />
  <h2><?php echo JText::_('J2STORE_CHECKOUT_SET_PASSWORD'); ?></h2>
  <span class="required">*</span> <?php echo JText::_('J2STORE_CHECKOUT_ENTER_PASSWORD'); ?><br />
  <input type="password" name="password" value="" class="large-field" />
  <br />
  <br />
  <span class="required">*</span> <?php echo JText::_('J2STORE_CHECKOUT_CONFIRM_PASSWORD'); ?> <br />
...
<?php if($this->params->get('bill_tax_number', 2) != 3 ): ?>
 ...
 <?php echo JText::_('J2STORE_TAX_ID'); ?><br />
<input type="text" name="tax_number" value="" class="large-field" />
<br />
<br />
<?php endif; ?>
<span class="required">*</span> <?php echo JText::_('J2STORE_ADDRESS1'); ?><br />
<input type="text" name="address_1" value="" class="large-field" />
<br />
<br />
<?php echo JText::_('J2STORE_ADDRESS2'); ?><br />
<input type="text" name="address_2" value="" class="large-field" />
<br />
<br />
<span class="required">*</span> <?php echo JText::_('J2STORE_CITY'); ?><br />
<input type="text" name="city" value="" class="large-field" />
<br />
<br />
<span id="payment-postcode-required" class="required">*</span> <?php echo JText::_('J2STORE_POSTCODE'); ?><br />
<input type="text" name="zip" value="<?php //echo $postcode; ?>" class="large-field" />
<br />
<br />
<span class="required">*</span> <?php echo $this->bill_country; ?><br />
<br />
<span class="required">*</span> <?php echo JText::_('J2STORE_STATE_PROVINCE'); ?><br />
