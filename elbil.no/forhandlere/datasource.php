...
$pass = "J5cyep!trekt5509";

//test
//$sheetId="tbvcyAfbXA5qEivwiANYTSQ";
//prod
$sheetId="tFwq4m6ah2AZLrCP-JVDC4Q";
...
if ($data = unserialize($Cache_Lite->get($id))) {
	...
	$doc->GetSpreadsheetFeed($sheetId);
	$doc->GetWorksheet();
	...
	if(isset($arrDetaljist) && isset($arrBilmerke) && count($arrBilmerke)>0 && count($arrDetaljist) >0){
		...
		//error_log("save cached data: $data");
