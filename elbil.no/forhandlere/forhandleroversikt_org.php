			...
			for (var i = 0; i < jQuery(data).length; i++) {
				...
				if(data[i].kjøretøy instanceof Array){
	        		for ( var j in data[i].kjøretøy){
	        			//console.error("Rad " + j.toString() + " - " + biltype[j].id + " : " + biltype[j].navn);
				...
				markers.push(
					    {
							firmanavn: data[i].firmanavn,
							adresse: data[i].adresse,
							kjøretøy : data[i].kjøretøy,
							poststed: data[i].poststed,
							posisjon: data[i].geopunkt,
					        latlng: new GLatLng( editLat, editLng ),
					        url: data[i].web,
					        name: '<div style="marging:10px; float:left; vertical-align: top;"><a href="'+ data[i].web +'" title="Se detaljer" target="_blank"><strong>' + data[i].firmanavn + '</strong></a><br/><a href="'+ data[i].web +'" title="Se detaljer" target="_blank">' + data[i].adresse + '</a><br/>Merke(r): ' + strMerker + '</div>',
					        //name: '<a href="'+ data[i].web +'" title="Se detaljer" target="_blank" style="text-decoration: none;display: inline; margin-right:10px;float:left;"><img src="http://nobil.no/img/' + bilde + '" alt="' + data[i].firmanavn +'" width="50px" style="border: 1px solid #ccc;display: inline;"/></a><div style="marging:10px; float:left; vertical-align: top;"><a href="'+ data[i].web +'" title="Se detaljer" target="_blank"><strong>' + data[i].firmanavn + '</strong></a><br/><a href="'+ data[i].web +'" title="Se detaljer" target="_blank">' + data[i].adresse + '</a><br/>Merke(r): ' + strMerker + '</div>',
