...
<link href="<?php echo $s5_directory_path ?>/css/IE9CSS3.css" rel="stylesheet" type="text/css"  />
<?php } ?>
	...
	<!-- Header -->			
		...
		<div id="s5_header_area_inner" class="s5_wrap">					
			...
			<div id="s5_header_wrap_inner">
				...
				<div id="s5_banners_wrap">
					<ul class="top-banners">
						<li>
							<?php s5_module_call('banner_top_1','notitle'); ?>
						</li>
						<li>
							<?php s5_module_call('banner_top_2','notitle'); ?>
						</li>
						<li>
							<?php s5_module_call('banner_top_3','notitle'); ?>
						</li>
						<li>
							<?php s5_module_call('banner_top_4','notitle'); ?>
						</li>
						<li>
							<?php s5_module_call('banner_top_5','notitle'); ?>
						</li>
						<li>
							<?php s5_module_call('banner_top_6','notitle'); ?>
						</li>
					</ul>
				</div>
				...
				<?php if ($s5_pos_search == "published") { ?>
					...
					<div id="s5_search_wrap" style="margin-top:0; padding: 0.4em 0.9em 0 0;">
						<?php if ($s5_facebook  != "") { ?>
						...
						<?php } ?>
						<div style="float: left; text-transform: uppercase; margin: 0.6em 0.6em 0 0;"><a href="/index.php?option=com_content&view=category&layout=blog&id=42&Itemid=114" title="Go to english version">English</a></div>
	...
	<!-- Center area -->	
		...
		<!-- End Above Columns Wrap -->			
			...
			<div id="s5_columns_wrap_inner">
				...
				<!-- End Left column -->	
				<!-- Right column -->
				<?php $s5_right_column_width = 250;?>	
				<?php if($s5_pos_right == "published" || $s5_pos_right_inset == "published" || $s5_pos_right_top == "published" || $s5_pos_right_bottom == "published") { ?>
					<!-- div id="s5_right_column_wrap" class="s5_float_left" style="width:<?php echo $s5_right_column_width ?>px !important; margin-left:-<?php echo $s5_right_column_width + $s5_left_column_width ?>px"-->
