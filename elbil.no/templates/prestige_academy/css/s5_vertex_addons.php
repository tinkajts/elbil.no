...
<?php if ($s5_responsive_tablet_hide != "" && $s5_responsive == "enabled"){ ?>
	...
	@media screen and (min-width:580px) and (max-width: 970px){
		...
		<?php if(is_array($s5_responsive_tablet_hide) && count($s5_responsive_tablet_hide) > 0){ echo @implode(",",$s5_responsive_tablet_hide); ?> {
			display:none;
		}
		<?php }?>
...
<?php if ($s5_responsive_mobile_hide != "" && $s5_responsive == "enabled"){ ?>
	...
	@media screen and (max-width: 579px){
		...
		<?php if(is_array($s5_responsive_mobile_hide) && count($s5_responsive_mobile_hide) > 0){ echo @implode(",",$s5_responsive_mobile_hide); ?> {
			display:none;
		}
		<?php }?>
