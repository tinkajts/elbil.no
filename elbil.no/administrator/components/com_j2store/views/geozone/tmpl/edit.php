...
function deleteGeoZoneRule(gzr_id,delete_btn){
	...
	var delete_url = "<?php echo JURI::base();?>index.php?option=com_j2store&view=geozone&task=geozone.deleteGeoZoneRule";
					...
					success : function(response) {
						...
						if (response.error != 1) {
							...
							var links = '<a rel="{handler:'+q+'iframe'+q+',size:{x: window.innerWidth-450, y: window.innerHeight-150}}" '
										+' href="index.php?option=com_j2store&view=geozone&task=geozone.setrule&id='+
										gzr_id+'&tmpl=component" 	class="modal"><input type="button" value="<?php echo JText::_('J2STORE_EDIT'); ?>" class=" btn btn-primary"></a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'
										+'<input onclick="deleteGeoZoneRule('+
										gzr_id+',this);" class="btn btn-danger" type="button" value="<?php echo JText::_('J2STORE_DELETE'); ?>">';
							//alert(links);
				...
				<table>
					...
					<tr>
						...
						<td><input type="button" id="CreateGeoZoneRule"
							value="<?php echo JText::_('J2STORE_GEOZONE_ADD_COUNTRY_OR_ZONE'); ?>"
				...
				<table class="adminlist table table-striped table-bordered">
					<thead>
						<tr>
							...
							<th><?php echo JText::_('J2STORE_GEOZONE_COUNTRY'); ?>

							</td>
							<th><?php echo JText::_('J2STORE_ZONE'); ?>
					...
					foreach($this->geozonerules as $grule) { ?>
						<tr>
							...
							if($grule->zone_id==0)
								echo JText::_('J2STORE_ALL_ZONES');
							else
								echo $grule->zone;
							?>
							</td>
							<td><a
								...
								href="index.php?option=com_j2store&view=geozone&task=geozone.setrule&id=<?php echo $grule->id;?>&tmpl=component"
								class="modal"><input type="button"
									value="<?php echo JText::_('J2STORE_EDIT'); ?>"
