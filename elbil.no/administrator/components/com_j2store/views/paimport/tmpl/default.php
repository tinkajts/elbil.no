...
$task='setpaimport';
$action = JRoute::_( 'index.php?option=com_j2store&view=products&task=setpaimport&tmpl=component&id='.$this->row->id);
?>
<h3>
	<?php echo JText::_( "J2STORE_PAI_IMPORT_ATTRIBUTE_FOR" ); ?>
	:
		...
		<div class="row-fluid">
			<div>
				<button class="btn btn-primary"
					...
					<?php echo JText::_('J2STORE_PAI_IMPORT_ATTRIBUTES'); ?>
				</button>
			</div>
			<table class="adminlist table table-striped">
				<thead>
					<tr>
						...
						<th style="text-align: left;"><?php echo JText::_( "J2STORE_PRODUCT_ATTRIBUTES" ); ?>
						</th>
	    ...
	    ?>
					<tr class='row<?php echo $k; ?>'>
					 ...
					 if(count($attributes)) {
					 		...
					 		if(count($a_options)) {
					 				echo '<strong>'.JText::_('J2STORE_PAI_OPTIONS_FOR_THIS_ATTRIBUTE').'</strong>';
					 				echo '<ol>';
					 				foreach ($a_options as $a_option) {
					 				?>
							<li><span><?php echo $a_option->productattributeoption_name; ?> </span>
								<span><?php echo $a_option->productattributeoption_prefix; ?>&nbsp;<?php echo $a_option->productattributeoption_price; ?>
							</span>
						</li> <?php 
					 				}
					 				echo '</ol>';
			...
			<input type="hidden" name="order_change" value="0" /> <input
				type="hidden" name="id" value="<?php echo $this->row->id; ?>" /> <input
