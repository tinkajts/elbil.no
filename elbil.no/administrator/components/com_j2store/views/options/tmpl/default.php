		...
		<tr>
		  ...
		  <table id="optionsList" class="adminlist table table-striped">
			...
			<tr>
				...
				<th class="name">
					<?php echo JHtml::_('grid.sort',  'J2STORE_OPTION_TYPE', 'a.option_type', $this->lists['order_Dir'], $this->lists['order']); ?>
				</th>
				<?php if (!version_compare(JVERSION, '3.0', 'ge')): ?>
				<th>
				...
				<th class="id">
					<?php echo JText::_('J2STORE_OPTION_VALUES'); ?>
				</th>
			</tr>
			</thead>
			...
			<tbody>
			   ...
			   <?php if (version_compare(JVERSION, '3.0', 'ge')): ?>
				...
				<?php endif; ?>
				     ...
				     <td> <?php
				     	echo J2StoreHelperOptions::convertKeysToText($item->type);
					...
					<?php endif; ?>
					 ...
					 ?>
						<?php if(in_array($item->type, $type_array )) : ?>
					 	[<?php echo J2StorePopup::popup( "index.php?option=com_j2store&view=options&task=setoptionvalues&option_id=".$item->option_id."&tmpl=component", JText::_( "J2STORE_OPTION_SET_OPTIONVALUES" ) ); ?>]
					 	<?php else: ?>
					 		<?php echo JText::_('J2STORE_NOT_APPLICABLE'); ?>
					 	<?php endif; ?>
					 </td>
