...
function deleteTaxRule(gzr_id,delete_btn){
	...
	var delete_url = "<?php echo JURI::base();?>index.php?option=com_j2store&view=taxprofile&task=taxprofile.deleteTaxRule";
					...
					success : function(response) {
						...
						if (response.error != 1) {
							...
							var links = '<a rel="{handler:'+q+'iframe'+q+',size:{x: window.innerWidth-450, y: window.innerHeight-150}}" '
										+' href="index.php?option=com_j2store&view=taxprofile&task=taxprofile.settaxrule&id='+
				...
				<table>
					<tr>
						...
						<td valign="top"><input type="button" id="CreateTaxRule"
							value="<?php echo JText::_('J2STORE_TAXPROFILE_ADD_TAXRATE'); ?>"
				...
				<table class="adminlist table table-striped ">
					<thead>
						<tr>
							...
							<th><?php echo JText::_('J2STORE_TAXPROFILE_TAXRATE'); ?>
					...
					foreach($this->taxrules as $trule) { ?>
						<tr>
							...
							<td><a
								...
								href="index.php?option=com_j2store&view=taxprofile&task=taxprofile.settaxrule&id=<?php echo $trule->id;?>&tmpl=component"
