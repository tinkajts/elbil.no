...
$action = JRoute::_('index.php?option=com_j2store&view=itemised');
		...
		<tr>
		  ...
		  <table id="optionsList" class="adminlist table table-striped">
			...
			<tr>
				<th>#</th>
				<th class="name">
					<?php echo JHtml::_('grid.sort',  'J2STORE_PRODUCT_ID', 'oi.product_id', $this->lists['order_Dir'], $this->lists['order']); ?>
				</th>

				<th class="name">
					<?php echo JHtml::_('grid.sort',  'J2STORE_PRODUCT_NAME', 'oi.orderitem_name', $this->lists['order_Dir'], $this->lists['order']); ?>
				</th>
				<th class="name">
					<?php echo JHtml::_('grid.sort',  'J2STORE_CATEGORY', 'category_name', $this->lists['order_Dir'], $this->lists['order']); ?>
				</th>
				<th class="name">
					<?php echo JHtml::_('grid.sort',  'J2STORE_REPORTS_ITEMISED_QUANTITY', 'sum', $this->lists['order_Dir'], $this->lists['order']); ?>
				</th>
				<th class="id">
					<?php echo JHtml::_('grid.sort',  'J2STORE_REPORTS_ITEMISED_PURCHASES', 'count', $this->lists['order_Dir'], $this->lists['order']); ?>
				</th>
			</tr>
			</thead>
			...
			<tbody>
			   ...
			   <td><?php echo $i+1; ?></td>
				...
				?>
				<a href="<?php echo 'index.php?option=com_j2store&view=orders&product_id='.$item->product_id.'&attribute='.base64_encode($item->orderitem_attributes); ?>" >
