...
class menujlist {
    ...
    public static $menujlist = '';
    
    static function CPANEL(){
        JToolBarHelper::title( JText::_('COM_JDOWNLOADS_BACKEND_CPANEL_MAIN'), 'jdlogo' ); 
    }

	static function EDIT_MENU(){ 
	...
	static function CATEGORIES_ADD(){
	...
	static function TEMPLATES_EDIT_CATS(){
    ...
    static function TEMPLATES_LIST_FILES(){
	...
	static function TEMPLATES_EDIT_FILES(){
    ...
    static function TEMPLATES_LIST_DETAILS(){
    ...
    static function TEMPLATES_EDIT_DETAILS(){
    ...
    static function TEMPLATES_LIST_SUMMARY(){
	...
	static function TEMPLATES_EDIT_SUMMARY(){
